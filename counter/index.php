...
<body class="bg-secondary-subtle">
    <nav class="navbar navbar-expand-lg bg-success bg-gradient fixed-top rounded-bottom">
        <div class="container" >
            <a class="navbar-brand text-light" href="">
                <h3>SINA</h3>
            </a>
            <div style="text-align: left;">
                <img src="Kementerian Agama.png" style="width: 50px; height: auto; vertical-align: middle; display: inline-block;">
                <span style="color: white; display: inline-block; vertical-align: middle;">KEMENAG Kab. Pasuruan</span>
            </div>
    ...
    <div class="container mt-5 pt-5 text-center">
        ...
        <div class="row mt-5">
            ...
            <div class="col-3">
                <button type="button" id="btnPHU" class="btn btn-success bg-gradient" style="font-size: 50px; width:100%; height:250%;">PHU</button>
            </div>
            <div class="col-3">
                <button type="button" id="btnSEKJEN" class="btn btn-success bg-gradient" style="font-size: 50px; width:100%; height:250%;">SEKJEN</button>
            </div>
            <div class="col-3">
                <button type="button" id="btnBIMAS" class="btn btn-success bg-gradient" style="font-size: 50px; width:100%; height:250%;">BIMAS</button>
            </div>
            <div class="col-3">
                <button type="button" id="btnPENDIS" class="btn btn-success bg-gradient" style="font-size: 50px; width:100%; height:250%;">PENDIS</button>
            </div>

        </div>
    </div>

    <footer class="fixed-bottom bg-success py-2 rounded-top">
