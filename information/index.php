        ...
        <div class="row mt-5">
            ...
            <div class="col-3">
                <div class="card text-center">
                    <div class="card-header bg-success fw-bold text-light">PHU</div>
                    <div class="card-body py-5 bg-success bg-gradient text-light">
            ...
            <div class="col-3">
                <div class="card text-center">
                    <div class="card-header bg-success fw-bold text-light">SEKJEN</div>
                    <div class="card-body py-5 bg-success bg-gradient text-light">
            ...
            <div class="col-3">
                <div class="card text-center">
                    <div class="card-header bg-success fw-bold text-light">BIMAS</div>
                    <div class="card-body py-5 bg-success bg-gradient text-light">
            ...
            <div class="col-3">
                <div class="card text-center">
                    <div class="card-header bg-success fw-bold text-light">PENDIS</div>
                    <div class="card-body py-5 bg-success bg-gradient text-light">
